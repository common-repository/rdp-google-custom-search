...
class RDP_GCS_ADMIN {
    ...
    static function add_menu_item()
    {
        ...
        add_menu_page( 'RDP Google Custom Search', 'RDP GCS', 'publish_posts', RDP_GCS_PLUGIN::$plugin_slug, 'RDP_GCS_ADMIN::generate_page',plugins_url('/rdp-google-custom-search/pl/images/menu-icon.gif') );
